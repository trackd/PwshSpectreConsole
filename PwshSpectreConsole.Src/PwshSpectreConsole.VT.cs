...
public static class VTParser {
    ...
    private static Color GetConsoleColor(int code)
        => code switch {
            0 => Color.Black,
            1 => Color.Navy,
            2 => Color.Green,
    ...
    private static Color Get256Color(int index) {
        ...
        if (index < 232) {
            ...
            int rIndex = colorIndex / 36;
            int gIndex = colorIndex % 36 / 6;
            int bIndex = colorIndex % 6;
            byte r = (byte)(rIndex * 51);
            byte g = (byte)(gIndex * 51);
            byte b = (byte)(bIndex * 51);
